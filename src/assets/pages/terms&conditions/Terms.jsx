      ...
      <main>
        <div className="container-conditions">
          <p className="conditions-description">
            ...
            authority. <br />
            Country refers to: United Kingdom Company (referred to as either
            “the Company”, “We”, “Us” or “Our” in this Agreement) refers to
            UnikaHR, 72 Ellenborough Road, DA14 5LA. <br />
            ...
            the Company regarding the use of the Service. Third-party Social
            Media Service means any services or content (including data,
            information, products or services) provided by a third-party that
            may be displayed, included or made available by the Service. Website
            refers to UnikaHR, accessible from https://unikahr.com You means the
            ...
            may not access the Service. You represent that you are over the age
            of 18. The Company does not permit those under 18 to use the
            Service. Your access to and use of the Service is also conditioned
            on Your acceptance of and compliance with the Privacy Policy of the
            ...
            Policy carefully before using Our Service. Intellectual Property The
            ...
            exclusive property of the Company and its licensors. <br />
            The Service is protected by copyright, trademark, and other laws of
            both the Country and foreign countries. Our trademarks and trade
            dress may not be used in connection with any product or service
            without the prior written consent of the Company. Links to Other
            ...
            available on or through any such web sites or services. <br />
            ...
            haven’t purchased anything through the Service. <br />
            ...
            even if the remedy fails of its essential purpose. Some states do
            not allow the exclusion of implied warranties or limitation of
            liability for incidental or consequential damages, which means that
            ...
            national, or international laws. Disputes Resolution If You have any
            concern or dispute about the Service, You agree to first try to
            resolve the dispute informally by contacting the Company. <br />
            ...
            country in which you are resident in. United States Legal Compliance
            ...
            please stop using the website and the Service. <br />
            Contact Us If you have any questions about these Terms and
            Conditions, You can contact us: By email: info@unikahr.com By
            visiting this page on our website: https://unikahr.com/contact/
          </p>
        </div>
      </main>
      <Footer />
